...
pub struct StatsResult {
    ...
    pub total_battle_plan_cost: usize,
...
impl Stats {
    pub fn new() -> Self {
        Self {
            ...
            last_tick_battle_plan_cost: 0,
            max_tick_entity_plan_cost: 0,
            max_tick_battle_plan_cost: 0,
        }
    }
    ...
    pub fn get_result(&self) -> StatsResult {
        StatsResult {
            ...
            total_battle_plan_cost: self.total_battle_plan_cost,
            ...
            last_tick_battle_plan_cost: self.last_tick_battle_plan_cost,
            max_tick_entity_plan_cost: self.max_tick_entity_plan_cost,
            max_tick_battle_plan_cost: self.max_tick_battle_plan_cost,
        }
    }
    ...
    pub fn total_battle_plan_cost(&self) -> usize {
        self.total_battle_plan_cost
    }
    ...
    pub fn add_battle_plan_cost(&mut self, number: usize) {
        self.total_battle_plan_cost += number;
        self.last_tick_battle_plan_cost = number;
    }
    ...
    pub fn set_last_tick_duration(&mut self, value: Duration) {
        ...
        if self.max_tick_duration < value {
            ...
            self.max_tick_battle_plan_cost = self.last_tick_battle_plan_cost;
        }
    }
}
